...
val ejerciciosPredeterminados = listOf<Ejercicio>(
    ...
    // 3. aperturas_con_mancuernas_banco_plano
    Ejercicio(
        id = 0L,
    ...
    // 4. aperturas_en_maquina_contractor
    Ejercicio(
        id = 0L,
    ...
    // 19. elevaciones_frontales_mancuernas
    Ejercicio(
        id = 0L,
    ...
    // 20. elevaciones_piernas_colgado
    Ejercicio(
        id = 0L,
    ...
    // 22. encogimiento_trapecios_mancuernas
    Ejercicio(
        id = 0L,
    ...
    // 23. extension_de_cuadriceps_maquina
    Ejercicio(
        id = 0L,
    ...
    // 24. extension_de_triceps_polea_alta
    Ejercicio(
        id = 0L,
    ...
    // 25. extension_triceps_mancuernas
    Ejercicio(
        id = 0L,
    ...
    // 50. remo_con_mancuerna_una_mano
    Ejercicio(
        id = 0L,
    ...
    // 56. sentadilla_bulgara_mancuernas
    Ejercicio(
        id = 0L,
