...
interface EjercicioDao {
    ...
    fun getEjerciciosGeneralesConBusqueda(usuarioId: String, searchText: String?): List<Ejercicio>
    ...
    fun getEjerciciosFavoritosConBusqueda(usuarioId: String, searchText: String?): List<Ejercicio>
    @Insert
